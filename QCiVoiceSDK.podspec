#
#  Be sure to run `pod spec lint QCiVoiceSDK.podspec' to ensure this is a
...
QCiVoiceSDK
  ...
  # Or just: spec.author    = "zhangwenbo"
  spec.authors            = { "zhangwenbo" => "zhangwenbo@corpize.com" }
  # spec.social_media_url   = "https://twitter.com/zhangwenbo"
  ...
  # ――― Project Settings ――――――――――――――――――――――――――――――――――――――――――――――――――――――――― #
  #
  #  If your library depends on compiler frflags you can set them in the xcconfig hash
